...
print('-' * 50, 'EVAL BASE', '-' * 50)
if machine == 'home':
	saved_model_path = '/home/kartik/Desktop/newton_results/pa2_complete/vos_models_base/vos_base_21699.pt'
	root_data_dir = '/home/kartik/data/youtube_vos'
	save_segmented_video_dir = '/home/kartik/Desktop/validation_vos_results_base'
	num_workers = 8

elif machine == 'newton':
	saved_model_path = '/home/cap6412.student4/pa2/vos_models_base/vos_base_21699.pt'
	root_data_dir = '/home/course.cap6412/youtubeVOS'
	save_segmented_video_dir = '/home/cap6412.student4/pa2/validation_vos_results_base'
	num_workers = 4
...
for i, sample in enumerate(data_loader):
	...
	for current_object_id in range(num_objects):
		...
		for video_frame_id in range(1, video_timesteps):
			xi = final_video[:, video_frame_id, :, :, :]
