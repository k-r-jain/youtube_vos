...
if machine == 'home':
	...
	save_models_dir = '/home/kartik/Desktop/vos_models_base'
	save_segmented_video_dir = '/home/kartik/Desktop/vos_results_base'
	loss_plot_save_path =  '/home/kartik/Desktop/loss_plot.png'
	batch_size = 2
	num_workers = 8
	num_epochs = 1
	fraction = 0.01
	...
	save_models_dir = '/home/cap6412.student4/pa2/vos_models_base'
	save_segmented_video_dir = '/home/cap6412.student4/pa2/vos_results_base'
	loss_plot_save_path =  '/home/cap6412.student4/pa2/loss_plot.png'
	batch_size = 4
	num_workers = 4
	num_epochs = 100
	fraction = 0.50
...
for epoch in range(num_epochs):
	...
	for i, sample in enumerate(ytvos):
		...
		name = sample['name']
		# image_names = sample['image_names'][1:] # To not save for the first frame annotation
		...
		for i in range(yhat_list[0].shape[0]):
			...
			for j in range(len(yhat_list)):
				...
				gen_mask = np.array(PIL.Image.fromarray(gen_mask).resize((final_width, final_height), resample = PIL.Image.BILINEAR))
	...
	if (epoch + 1) % SAVE_EVERY_N_EPOCH == 0:
		...
		torch.save({
			...
			'convlstmcell': convlstmcell.state_dict(),
...
# 		# from skimage.transform import resize as skresize
# 		# gen_mask = skresize(gen_mask, (720, 1280), anti_aliasing = False)
